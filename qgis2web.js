...
map.getView().fit([12457374.477617, -879827.236950, 12478661.543223, -867287.547461], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Service Area Halte Bus Kota Kediri</h2>';
        return titleElement;
    })(),
